...
if __name__ == "__main__":
    ...
    if iniciando:
        ...
        while True:
            ...
            querys.registrar_estados(1, "ACTIVO")
            querys.registrar_estados(2, "DETENIDO")
            querys.registrar_estados(3, "PENDIENTE")
            querys.registrar_estados(4, "COMPLETADO")
            querys.registrar_estados(5, "MASTER")

            querys.registrar_estados_preparativos(1, "DESPACHO")
            querys.registrar_estados_preparativos(2, "RETIRO")
            querys.registrar_estados_preparativos(3, "LIMPIEZA")
            querys.registrar_estados_preparativos(4, "MANTENCION")

            querys.registrar_estados_preparativos(5, "COMPLETADO")
            querys.registrar_estados_preparativos(6, "SINIESTRADO")
            querys.registrar_estados_preparativos(7, "DETENIDO")
            querys.registrar_estados_preparativos(8, "CERRADO")

            querys.registrar_estado_gastos(1, "COMUNES")
            querys.registrar_estado_gastos(2, "REMUNERACIONES")
            querys.registrar_estado_gastos(3, "TRANSPORTES")
            querys.registrar_estado_gastos(4, "INSUMOS")
            querys.registrar_estado_gastos(5, "ARRIENDO")
            querys.registrar_estado_gastos(6, "COMBUSTIBLES")
            querys.registrar_estado_gastos(7, "INMUEBLES")
            querys.registrar_estado_gastos(8, "SIN BOLETAS/SIN DOCUMENTOS")
            querys.registrar_estado_gastos(9, "OTROS")
